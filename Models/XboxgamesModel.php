...
class XboxgamesModel extends Model
{
    protected $table = 'xboxgames';
    protected $primaryKey = 'id';
    protected $allowedFields = ['productname', 'description', 'price', 'image', 'category'];
    protected $returnType = 'array'; // <-- Important: return arrays instead of objects
    ...
    public function filterProducts($filters = [], $sort = null)
{
    ...
    {
        return $this->find($id); // returns array because of returnType
    }
}
