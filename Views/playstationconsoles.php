...
<option value="digitaledition">Digital Editon</option>
<option value="seriesz">Series z</option>
...
<img src="<?= !empty($product['image']) && file_exists(FCPATH . 'images/' . $product['image']) ? base_url('images/' . $product['image']) : base_url('images/default.png') ?>" 
